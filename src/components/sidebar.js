    ...
    const contentSidebar = (pageBar) =>{
        switch (pageBar) {
            case 'home':
                ...
                <Link to="/">
                    <button onClick={() => {sessionStorage.removeItem('accessJWT'); sessionStorage.removeItem('role')}} className="flex py-2 hover:bg-gray-900 w-full px-4">
